	...
	BMo_scrollLightboxGallery.prototype = {
		...
		showGallery:function(){
			...
			if(this.gallery.options.slG_responsive){
				if(this.isVertical){
					this.resizeGallery(this.gallery.options.thumbs_width,this.gallery.options.gallery_height);
				}else{
					this.resizeGallery(this.$gallery_obj.width(),this.gallery.options.thumbs_height);
				}
			}else{
