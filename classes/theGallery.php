...
class bmoExpo {
     ...
     public function BMo_Expo_activation() {
        ...
        $options = array(
			'replaceWPGallery'=>  array('type' => 'common_php','valtype' => 'select', 'default' =>'scrollGallery', 'possibilities' => array('sG' =>  'scrollGallery','slG' => 'scrollLightboxGallery', 0 =>'Do not replace'),'desc' => 'Replace the Wordpress [gallery] shortcode'),
            ...
            'duration'        =>  array('type' => 'common','valtype' => 'string', 'default' =>'slow', 'desc' => 'duration (number or string)[slow, fast]: Animation duration, durations are given in milliseconds or with the keywords slow and fast; higher values indicate slower animations.'),
            'gallery_width'   =>  array('type' => 'common','valtype' => 'int', 'default' =>600, 'desc' => 'gallery_width (number):  gallery width'),
            'gallery_height'  =>  array('type' => 'common','valtype' => 'int', 'default' =>400, 'desc' => 'gallery_height (number):  gallery height'),
            ...
            'sG_loop'            =>  array('type' => 'sG','valtype' => 'bool', 'default' =>true, 'desc' => 'sG_loop (boolean): scroll back to the first image after the last.'),
            'sG_loopThumbs'      =>  array('type' => 'sG','valtype' => 'bool', 'default' =>true, 'desc' => 'sG_loopThumbs (boolean): scroll back to the first thumbnail after the last'),
            'sG_clickable'      =>  array('type' => 'sG','valtype' => 'bool', 'default' =>true, 'desc' => 'sG_clickable (boolean): are the images clickable?'),
            'sG_opacity'         =>  array('type' => 'sG','valtype' => 'int', 'default' =>40, 'desc' => 'sG_opacity (number): transparency of the thumbs'),
            'sG_area'            =>  array('type' => 'sG','valtype' => 'int', 'default' =>200, 'desc' => 'sG_area (number): px width of the area inside the thumbs in which the thumbs are not scrolling if the mouse is inside'),
            'sG_scrollSpeed'     =>  array('type' => 'sG','valtype' => 'int', 'default' =>2, 'desc' => 'sG_scrollSpeed (number): thumbnail scroll speed, should be >0'),
            'sG_autoScroll'      =>  array('type' => 'sG','valtype' => 'bool', 'default' =>false, 'desc' => 'sG_autoScroll (boolean): autoscroll the thumbnails'),
            'sG_aS_stopOnOver'   =>  array('type' => 'sG','valtype' => 'bool', 'default' =>true, 'desc' => 'sG_aS_stopOnOver (boolean): stop scrolling on mouse over'),
            'sG_diashowDelay'    =>  array('type' => 'sG','valtype' => 'int', 'default' =>0, 'desc' => 'sG_diashowDelay (number): diashow delay time in seconds; use a number to activate the diashow feature; deactivate diashow with value 0'),
            ...
            'slG_area'    		 =>  array('type' => 'slG','valtype' => 'int', 'default' =>200, 'desc' => 'slG_area (number): px width of the area inside the thumbs in which the thumbs are not scrolling if the mouse is inside'),
			'slG_scrollSpeed'    =>  array('type' => 'slG','valtype' => 'int', 'default' =>2, 'desc' => 'slG_scrollSpeed (number): '),
			'slG_autoScroll' 	 =>  array('type' => 'slG','valtype' => 'bool', 'default' =>false, 'desc' => 'slG_autoScroll (boolean): autoscroll the thumbnails'),
			'slG_aS_stopOnOver'  =>  array('type' => 'slG','valtype' => 'bool', 'default' =>true, 'desc' => 'slG_aS_stopOnOver (boolean): stop scrolling on mouse over'),
			
			'slG_responsive'	 =>  array('type' => 'slG','valtype' => 'bool', 'default' =>true, 'desc' => 'slG_responsive (boolean):  makes the width responsive and the gallery width relative to parent elements width'),
			'slG_relType'	 	 =>  array('type' => 'slG','valtype' => 'string', 'default' =>"'lightbox|_{id}_|'", 'desc' => 'slG_relType (string): rel-attribute value ({id} will be replaced by the gallery type and the id. "|_" will be replaces by "[" and "_| by "]" - it is not possible to use "[ ]" inside shortcodes)'),
			'slG_useLightbox'	 =>  array('type' => 'slG','valtype' => 'bool', 'default' =>true, 'desc' => 'slG_useLightbox (boolean): open images with the colorbox script by <a href="http://www.jacklmoore.com/" target="_blank">Jack Moore</a>'),
			'slG_lightbox_text'	 =>  array('type' => 'slG','valtype' => 'string', 'default' =>"'image {current} of {total}'", 'desc' => 'slG_lightbox_text (string): colorbox text for the group counter ({current} and {total} will be replaced)'),
			'slG_lightbox_opacity'	 =>  array('type' => 'slG','valtype' => 'int', 'default' =>85, 'desc' => 'slG_lightbox_opacity (number): colorbox background opacity in %'),
			'slG_lightbox_slideshow'	 =>  array('type' => 'slG','valtype' => 'bool', 'default' =>false, 'desc' => 'slG_lightbox_slideshow (boolean): use the colorbox slideshow feature?'),
			'slG_lightbox_speed'	 =>  array('type' => 'slG','valtype' => 'int', 'default' =>2500, 'desc' => 'slG_lightbox_speed (number): colorbox slideshow delay in ms'),
        );
	 ...
	 private function BMo_Expo_GenerateHtml($arr_configuration, $type="scrollGallery", $pictures = NULL){
		...
		$id = $arr_configuration['id'];
		 ...
		 if (empty($pictures)&&!empty($id)) {
		  ...
		  if (empty($pictures)||!is_array($pictures)) return "[No pictures in galley]";
