...
class bmoExpo {
     ...
     public function BMo_Expo_activation() {
        ...
        $options = array(
            ...
            'sG_start'           =>  array('type' => 'sG','valtype' => 'int', 'default' =>1, 'desc' => 'Start at picture number ..., the first picture is number 1:'),
            'sG_thumbPosition'   =>  array('type' => 'sG','valtype' => 'select', 'default' =>'top', 'possibilities' => array('top', 'right', 'bottom', 'left', 'none'), 'desc' => 'Position of the thumbs:'),
            'sG_images'          =>  array('type' => 'sG','valtype' => 'bool', 'default' =>true, 'desc' => 'Show the images?'),
			...
			'slG_aS_stopOnOver'  =>  array('type' => 'slG','valtype' => 'bool', 'default' =>true, 'desc' => 'Stop scrolling on mouse over?'),
			
			'slG_responsive'	 =>  array('type' => 'slG','valtype' => 'bool', 'default' =>true, 'desc' => 'Makes the width responsive and the gallery width relative to parent elements width?'),
			'slG_relType'	 	 =>  array('type' => 'slG','valtype' => 'string', 'default' =>"'lightbox|_{id}_|'", 'desc' => 'Rel-attribute value ({id} will be replaced by the gallery type and the id. "|_" will be replaces by "[" and "_| by "]" - it is not possible to use "[ ]" inside shortcodes)'),
			'slG_useLightbox'	 =>  array('type' => 'slG','valtype' => 'bool', 'default' =>true, 'desc' => 'Open images with the colorbox script by <a href="http://www.jacklmoore.com/" target="_blank">Jack Moore</a>:'),
			'slG_lightbox_text'	 =>  array('type' => 'slG','valtype' => 'string', 'default' =>"'image {current} of {total}'", 'desc' => 'Colorbox text for the group counter ({current} and {total} will be replaced):'),
			'slG_lightbox_opacity'	 =>  array('type' => 'slG','valtype' => 'int', 'default' =>85, 'desc' => 'Colorbox background opacity in %:'),
			'slG_lightbox_slideshow'	 =>  array('type' => 'slG','valtype' => 'bool', 'default' =>false, 'desc' => 'Use the colorbox slideshow feature?'),
			'slG_lightbox_speed'	 =>  array('type' => 'slG','valtype' => 'int', 'default' =>2500, 'desc' => 'Colorbox slideshow delay in ms:'),
        );
