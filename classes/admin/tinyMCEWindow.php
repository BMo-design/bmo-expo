...
<body style="display: none">
	<form name="BMoExpo" action="#">
		<ul class='nav nav-tabs' id='bmoTab' data-tabs='tabs'>
	    	<li class='active'><a id='tab_gallery' href='#gallery' data-toggle='tab'>Gallery</a></li>
	    	<li class=''><a id='tab_tag' href='#tag' data-toggle='tab'>Tag</a></li>
	    </ul>
		<div class='tab-content'>
			<div class='tab-pane active' id='gallery'>
				...
				<table border="0" cellpadding="4" cellspacing="0" class="form-table" style="width:auto">
		         <tr>
		            <td nowrap="nowrap"><label for="gallerytag">1. Select a NextGen Gallery:</label></td>
			...
			<div class='tab-pane' id='tag'>
				...
				<table border="0" cellpadding="4" cellspacing="0" class="form-table" style="width:auto">
		         <tr>
		            <td nowrap="nowrap"><label for="gallerytag">1. Select images by NextGen Gallery Tags:</label></td>
		            <td><input class="gallerytag" name="gallerytag" style="width: 200px" value="" /> <span class="small">(separate tags by comma)</span>
		            </td>
		          </tr>
				</table>
			</div>
		...
		<div id="galleryoptions">
			<p class="header">3. Gallery options:<span class="arrows">&nbsp;</span></p>
